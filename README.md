...
Le contrôle TypeScript et 35 tests automatisés passent, dont les répétitions 1, 2, 3, 5 et 10 fois, les 6 236 correspondances de Tajweed et de traduction, l'intégrité des 604 images Tajweed, l'identification exacte d'une zone de verset dans le Moushaf de Médine, l'exclusion des objectifs entièrement connus et la sauvegarde des quatre thèmes. Le parcours depuis An-Nâs couvre les 6 236 versets une seule fois et termine par Al-Fatiha. Les compilations iOS et Android de la version 0.6.0 et les interactions sur de vrais téléphones restent à vérifier.
