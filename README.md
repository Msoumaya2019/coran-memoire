...
Le contrôle TypeScript et 42 tests automatisés passent, dont le transfert au quatrième jour, l’absence de doublons entre catégories, le rattrapage progressif, le découpage d’un juz’ complet, les répétitions audio et l’intégrité des 604 images Tajweed. L’export Metro iOS et Android de la version 0.7.0 a réussi. Les compilations GitHub iOS et Android de la version 0.6.0 ont réussi. La version 0.7.0 et le microphone, la synchronisation et les règles d’accès des récitations restent à essayer sur deux vrais comptes et sur des téléphones iOS et Android avant de considérer ces parcours comme validés.
