...
Le lecteur de séance diffuse les fichiers MP3 par verset d’[Al Quran Cloud](https://alquran.cloud/cdn). Il propose trois éditions : `ar.husary`, `ar.alafasy` et `ar.minshawi`, dont les récitants sont présentés en lecture Hafs ‘an ‘Âsim par [MP3Quran pour Al-Husary](https://www.mp3quran.net/eng/husr/1), [Alafasy](https://www.mp3quran.net/eng/afs/1) et [Al-Minshawi](https://www.mp3quran.net/eng/minsh/1). Les fichiers restent hébergés par la source ; l’application ne les republie pas. Consulter les [conditions d’Al Quran Cloud](https://alquran.cloud/terms-and-conditions) avant tout ajout de téléchargement hors ligne ou de distribution audio. Les répétitions sont calculées sur la plage de versets Hafs de la séance.
