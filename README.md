...
Le lecteur de séance diffuse les fichiers MP3 par verset d’[Al Quran Cloud](https://alquran.cloud/cdn), dans l’édition `ar.husary` de Mahmoud Khalil Al-Husary. La lecture de ce récitateur est indiquée comme Hafs ‘an ‘Âsim par [MP3Quran](https://www.mp3quran.net/eng/husr/1). Les fichiers restent hébergés par la source ; l’application ne les republie pas. Consulter les [conditions d’Al Quran Cloud](https://alquran.cloud/terms-and-conditions) avant tout ajout de téléchargement hors ligne ou de distribution audio. Les répétitions sont calculées sur la plage de versets Hafs de la séance.
